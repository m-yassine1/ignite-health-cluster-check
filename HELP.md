...
* The original package name 'com.ignite.cluster.health.ignite-cluster-health' is invalid and this project uses 'com.ignite.cluster.health.igniteclusterhealth' instead.
...
```
$ docker run --rm -p 8080:8080 ignite-cluster-health:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/ignite-cluster-health
```
